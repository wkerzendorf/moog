...
c*****Reading command line arguments
       ...
       if (nargs .eq. 0) then
              ...
              print*, "Please only specify 1 argument"
              call exit(-1)
       end if
...
c      moogpath = 
c     .  '/Users/wkerzend/software/moog2010.1/'
...
c      write (smt1,1018)
      smt1 = 'x11 -bg black -title MOOGplot -geom 1200x350+20+450'
     .  // char(0)
c     now do the same for line abundance trend plots (short but tall).
c      write (smt2,1017)
      smt2 = 'x11 -bg black -title MOOGplot -geom 700x800+650+000' 
     . // char(0)
...
c*****or else you are out of luck!
         ...
         array = control // 
     .   ' IS NOT ONE OF THE DRVERS.  TRY AGAIN (y/n)?'
      print*, array
...
c1018  format ('x11 -bg black -title MOOGplot -geom 1200x350+20+450')
