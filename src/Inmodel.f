...
c     
      do i=1,ntau
         numdens(1,1,i) = xamol(1,i)                                    c H I
         numdens(1,2,i) = xmol(1,i)                                     c H II
         numdens(2,1,i) = xamol(2,i)                                    c He I
         numdens(2,2,i) = xmol(2,i)                                     c Hi II
         numdens(3,1,i) = xamol(3,i)                                    c C I
         numdens(3,2,i) = xmol(3,i)                                     c C II
         numdens(4,1,i) = xamol(6,i)                                    c Mg I
         numdens(4,2,i) = xmol(6,i)                                     c Mg II
         numdens(5,1,i) = xamol(7,i)                                    c Al I
         numdens(5,2,i) = xmol(7,i)                                     c Al II
         numdens(6,1,i) = xamol(8,i)                                    c Si I
         numdens(6,2,i) = xmol(8,i)                                     c Si II
         numdens(7,1,i) = xamol(16,i)                                   c Fe I
         numdens(7,2,i) = xmol(16,i)                                    c Fe II
         numdens(8,1,i) = xmol(17,i)                                    c H_2
      enddo
